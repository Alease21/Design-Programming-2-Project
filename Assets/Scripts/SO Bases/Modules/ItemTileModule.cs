...
namespace WFC
{
    ...
    public class ItemTileModule : ScriptableObject, IModule
    {
        //public Vector2Int keyDepthByModuleWidth;
        public int keyDepth;
        public int moduleWidth;

        [SerializeField] private ItemTileModule[] _northNeighbours;
        [SerializeField] private ItemTileModule[] _eastNeighbours;
        [SerializeField] private ItemTileModule[] _southNeighbours;
        [SerializeField] private ItemTileModule[] _westNeighbours;

        [SerializeField] private TileBase[] _trueTiles;
        [SerializeField] private TileBase[] _nKey, _eKey, _sKey, _wKey;

        public IModule[] North { get => _northNeighbours; set => _northNeighbours = value as ItemTileModule[]; }
        public IModule[] East { get => _eastNeighbours; set => _eastNeighbours = value as ItemTileModule[]; }
        public IModule[] South { get => _southNeighbours; set => _southNeighbours = value as ItemTileModule[]; }
        public IModule[] West { get => _westNeighbours; set => _westNeighbours = value as ItemTileModule[]; }
