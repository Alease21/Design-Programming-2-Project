...
namespace MagicSystem
{
    public class SpellData
    {
        ...
        public void DetermineSpellAnimName(TargetingStrategy tarStrat)
        {
            ...
            if (GetSpellElement == SpellElements.Magic)
                animNamePrefix = "Magic";
            else if (GetSpellElement == SpellElements.Fire)
                animNamePrefix = "Fire";
            else if (GetSpellElement == SpellElements.Poison)
                animNamePrefix = "Poison";
            else if (GetSpellElement == SpellElements.Healing)
            ...
            _spellAnimName = subFolderPath + animNamePrefix + animNameSuffix;
        }
    }
}